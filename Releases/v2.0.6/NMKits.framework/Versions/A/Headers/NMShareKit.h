...
- (void)fbGetProfileWithPermissions:(NSArray*)premissions userFields:(NSArray*)fields
                  completionHandler:(NMShareKitCompletionHandler)completionHandler;
- (void)fbLogout:(NMShareKitCompletionHandler)completionHandler;
...
- (void)gPlusPostPhoto:(UIImage*)image message:(NSString*)message completionHandler:(NMShareKitCompletionHandler)completionHandler;
...
- (void)gPlusLogout:(NMShareKitCompletionHandler)completionHandler;
